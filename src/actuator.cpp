...
#if (ENABLE_ACTUATOR_MX28_PROTOCOL2 || ENABLE_ACTUATOR_MX64_PROTOCOL2 || ENABLE_ACTUATOR_MX106_PROTOCOL2 || ENABLE_ACTUATOR_XL330 || ENABLE_ACTUATOR_XC330 || ENABLE_ACTUATOR_XL430 || ENABLE_ACTUATOR_XC430 || ENABLE_ACTUATOR_XM430 || ENABLE_ACTUATOR_XH430 || ENABLE_ACTUATOR_XD430 || ENABLE_ACTUATOR_XM540 || ENABLE_ACTUATOR_XH540 || ENABLE_ACTUATOR_XD540 || ENABLE_ACTUATOR_XW540 || ENABLE_ACTUATOR_XW430)
    {ControlTableItem::MODEL_NUMBER, 0, 2},
...
#if (ENABLE_ACTUATOR_MX64_PROTOCOL2 || ENABLE_ACTUATOR_MX106_PROTOCOL2)
...
#if (ENABLE_ACTUATOR_XL430 || ENABLE_ACTUATOR_XC430)
    {ControlTableItem::PRESENT_LOAD, 126, 2},
#endif
    {ControlTableItem::LAST_DUMMY_ITEM, 0, 0}};

const ModelControlTableInfo_t xmh430_xl330_control_table[] PROGMEM = {
#if (ENABLE_ACTUATOR_XL330 || ENABLE_ACTUATOR_XC330 || ENABLE_ACTUATOR_XM430 || ENABLE_ACTUATOR_XH430)
    {ControlTableItem::CURRENT_LIMIT, 38, 2},
    {ControlTableItem::GOAL_CURRENT, 102, 2},
    {ControlTableItem::PRESENT_CURRENT, 126, 2},
#endif
...
/*
 * @brief Get Control Table Item Information
 * @param model_num Dynamixel model number
 * @param control_item Control Table Item Index
 * @return ControlTableItemInfo_t containing address and length of the control item
 */
